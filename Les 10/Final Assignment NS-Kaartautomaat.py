def inlezen_beginstation(stations):
    while True:
        inp_beginstation = input("Voer een begin station?\n>> ")
        if inp_beginstation in stations:
            return inp_beginstation
        else:
            print("Het station bestaat niet, voer een geldig station in!\n")


def inlezen_eindstation(stations, beginstation):
    while True:
        inp_eindstation = input("Voer een eind station?\n>> ")
        if inp_eindstation in stations:
            ...
            print("Dit station bestaat niet in deze route!\n")
